          ...
          <div class="flex flex-col md:flex-row gap-8 relative z-10">
            <div class="flex-1 space-y-4">
              <div
                ...
                <i class="pi pi-book"></i> Documentação Rápida
              </div>
            ...
            <div
              ...
              <div
                ...
                <i class="pi pi-copy cursor-pointer hover:text-white transition-colors" v-tooltip="'Copiar'"
                  @click="copyCode"></i>
              </div>
        ...
        <div
          ...
          <div class="flex-1 relative">
            ...
            <div v-else class="h-full">
              <DataTable :value="results" stripedRows paginator :rows="12" size="small" responsiveLayout="scroll"
                class="modern-table"
